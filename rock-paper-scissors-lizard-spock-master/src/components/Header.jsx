...
const Header = ({ points }) => {
    return (
        <div className="w-full h-28 sm:big-screen:h-40 max-w-[700px] p-3 flex justify-between items-center border-4 border-header-outline rounded-lg sm:big-screen:rounded-2xl sm:big-screen:px-6 sm:mobile-landscape:scale-50 sm:mobile-landscape:-mt-6 sm:big-screen:py-4">
