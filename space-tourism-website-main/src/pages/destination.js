...
const Destination = () => {
    ...
    return (
        <Layout background="destination">
            <main className="main-mobile flex-1 gap-4 p-8 pt-2 md:justify-between md:pt-10 lg:flex-row lg:justify-between lg:p-0 lg:px-32">
                <section className="flex h-full w-full flex-col items-center justify-between gap-4 md:gap-8 lg:w-1/2 lg:justify-start lg:gap-32 ">
                    <h3 className="section-title md:self-start">
                        <span className="font-bold opacity-25">01</span>PICK
                        YOUR DESTINATION
                    </h3>
                    <img
                        className="w-[170px] p-4 md:w-[300px] lg:w-[445px] lg:self-end lg:p-0"
                        src={images[target]}
                        alt="moon"
                        width={200}
                    />
                </section>
                <section className="flex flex-col items-center justify-around gap-4 lg:w-2/5 lg:items-start lg:gap-8 lg:justify-self-end">
                    ...
                    <p className="section-p w-full text-[15px] md:w-auto md:px-16 md:text-base lg:px-0 lg:text-left lg:text-[18px]">
                        {info[target].description}
                    </p>
                    <hr className="my-4 w-full border-t border-separator md:my-10 md:mb-8" />
