...
const Menu = () => {
    ...
    return (
        <div className={`w-screen ${showMenu && 'h-full'} p-0 text-sm max-md:absolute flex flex-col`}>
                <div 
                ...
                >
                    <div className='ml-auto w-full h-full max-md:w-2/3 max-md:p-6 bg-almost-white flex items-center max-md:flex-col max-md:h-screen max-md:text-xl max-md:items-start'>
                        <div className='group py-4 hover:text-almost-black cursor-pointer max-md:w-full max-md:mt-12'>
                            ...
                            <ul className='absolute hidden -ml-12 mt-3 py-4 px-6 bg-white rounded-lg shadow-2xl  group-hover:block text-medium-gray max-md:m-0 max-md:bg-almost-white max-md:shadow-none max-md:static max-md:pl-10'>
                                <li className='flex items-center py-2 hover:text-almost-black'><img className='pr-4 max-md:w-9' src={iconTodo} alt="todo list" />Todo List</li>
                                <li className='flex items-center py-2 hover:text-almost-black'><img className='pr-4 max-md:w-9' src={iconCalendar} alt="calendar" />Calendar</li>
                                <li className='flex items-center py-2 hover:text-almost-black'><img className='pr-4 max-md:w-9' src={iconReminders} alt="reminders" />Reminders</li>
                                <li className='flex items-center py-2 hover:text-almost-black'><img className='pr-4 max-md:w-9' src={iconPlanning} alt="planning" />Planning</li>
                            </ul>
                        </div>
                        <div className="group py-4 hover:text-almost-black cursor-pointer max-md:w-full">
                            ...
                            <ul className='absolute hidden mt-3 py-4 px-6 bg-white rounded-lg shadow-2xl align-middle group-hover:block text-medium-gray max-md:m-0 max-md:bg-almost-white max-md:shadow-none max-md:w-full max-md:align-middle max-md:static max-md:pl-0'>
                                <li className='py-1 hover:text-almost-black max-md:px-10'>History</li>
                                <li className='py-1 hover:text-almost-black max-md:px-10'>Our Team</li>
                                <li className='py-1 hover:text-almost-black max-md:px-10'>Blog</li>
                            </ul>
                        </div>
